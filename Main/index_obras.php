                  ...
                  <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <img src="./img/plano_gral.png" alt="Plano General">
                      </div>
                    </div>
                  </div>
=======
...
>>>>>>> c42d1aa87e86fba999e7162c7ef474d7a9aaf104
  ...
  <div class="items-container display-flex row justify-content-center">
    ...
    ?>
      ...
      <a href="test.php?atraccion=<?php print($fila["ID"]) ?>" class="card col-3">
        <strong class="card_title"><?php echo ' ' . $fila["nombre"] . '_' . $fila["ID"]; //estaba testeando como quedaba con la cantidad en el titulo
                                    ?></strong>
        <div class="card__body">
